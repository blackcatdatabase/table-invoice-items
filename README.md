...
> Lineage: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 5 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\invoice-items](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\invoice-items) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package invoice-items -Apply
