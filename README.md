...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 5 · Changelog: fresh (18 d)</div>
</div>
...
- Pkg folder: [packages\invoice-items](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\invoice-items)
...
graph LR
  ...
  invoice_items["invoice_items"]:::center
  invoice_items -->|FK| invoices["invoices"]:::link
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package invoice-items -Apply
