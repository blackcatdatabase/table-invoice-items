...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'invoice_id', 'line_no', 'description', 'unit_price', 'quantity', 'tax_rate', 'tax_amount', 'line_total', 'currency', 'created_at', 'updated_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'invoice_id', 'line_no' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'tenant_id', 'invoice_id', 'line_no', 'quantity' ]; }
