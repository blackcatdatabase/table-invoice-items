...
final class Definitions {
    ...
    public static function uniqueKeys(): array { return [ [ 'invoice_id', 'line_no' ], [ 'constraint' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'invoice_id', 'line_no', 'quantity' ]; }
