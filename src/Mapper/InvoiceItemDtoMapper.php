...
namespace BlackCat\Database\Packages\InvoiceItems\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO InvoiceItemDto:
...
final class InvoiceItemDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'id' => 'id', 'tenant_id' => 'tenantId', 'invoice_id' => 'invoiceId', 'line_no' => 'lineNo', 'description' => 'description', 'unit_price' => 'unitPrice', 'quantity' => 'quantity', 'tax_rate' => 'taxRate', 'tax_amount' => 'taxAmount', 'line_total' => 'lineTotal', 'currency' => 'currency', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'tenant_id', 'invoice_id', 'line_no', 'quantity' ];
    /** @var string[] */
    private const FLOAT_COLS  = [ 'unit_price', 'tax_rate', 'tax_amount', 'line_total' ];
    /** @var string[] */
     ...
     */
    public static function fromRow(array $row): InvoiceItemDto
    {
        /** @var InvoiceItemDto */
    ...
    public static function fromRowOrNull(?array $row): ?InvoiceItemDto
    {
     ...
     */
    public static function toRow(InvoiceItemDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(InvoiceItemDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(InvoiceItemDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(InvoiceItemDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,InvoiceItemDto>
     */
