...
final class InvoiceItemDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'invoice_id' => 'invoiceId', 'line_no' => 'lineNo', 'unit_price' => 'unitPrice', 'tax_rate' => 'taxRate', 'tax_amount' => 'taxAmount', 'line_total' => 'lineTotal' ];
    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'invoice_id', 'line_no', 'quantity' ];
    /** @var string[] */
    ...
    public static function fromRow(array $row): InvoiceItemDto {
        ...
        $rc   = new \ReflectionClass(InvoiceItemDto::class);
