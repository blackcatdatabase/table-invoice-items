...
final class InvoiceItemsModule implements ModuleInterface
{
    public function name(): string { return 'table-invoice_items'; }
    public function table(): string { return 'invoice_items'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-invoices' ]; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_invoice_items_tenant_invoice' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_invoice_items_invoice' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_invoice_items_tenant_invoice' ],
            'foreignKeys' => [ 'fk_invoice_items_invoice' ],
        ];
    }
}
