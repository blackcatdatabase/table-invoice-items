...
final class InvoiceItemRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`invoice_items`' : '"invoice_items"';
     ...
     * [ 'invoice_id', 'line_no' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'description', 'unit_price', 'quantity', 'tax_rate', 'tax_amount', 'line_total', 'currency' ] = které sloupce aktualizovat.
     */
    public function upsert(array $row): void {
        ...
        $upd  = [ 'description', 'unit_price', 'quantity', 'tax_rate', 'tax_amount', 'line_total', 'currency' ];
