...
use BlackCat\Database\Packages\InvoiceItems\Repository\InvoiceItemRepository as GeneratedRepository;
...
{
  private InvoiceItemRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof InvoiceItemRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected InvoiceItemRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\InvoiceItems\Dto\InvoiceItemDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\InvoiceItems\Dto\InvoiceItemDto|null { return $this->repo->getById($id, $asDto); }
