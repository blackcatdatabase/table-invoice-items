...
final class Repository
{
    ...
    {
        $this->repo = new InvoiceItemRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\InvoiceItems\Dto\InvoiceItemDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\InvoiceItems\Dto\InvoiceItemDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\InvoiceItems\Dto\InvoiceItemDto|null
    {
