...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'tenant_id', 'invoice_id', 'line_no', 'description', 'unit_price', 'quantity', 'tax_rate', 'tax_amount', 'line_total', 'currency' ];
    }
    ...
    {
        $x = [ 'id', 'tenant_id', 'invoice_id', 'line_no', 'description', 'unit_price', 'quantity', 'tax_rate', 'tax_amount', 'line_total', 'currency' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\InvoiceItems\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\InvoiceItems\Definitions::softDeleteColumn();
