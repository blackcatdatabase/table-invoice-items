 ...
 * - whitelist filtrů: [ 'id', 'invoice_id', 'line_no', 'description', 'unit_price', 'quantity', 'tax_rate', 'tax_amount', 'line_total', 'currency' ]
 * - whitelist pro LIKE hledání: [ 'description', 'currency' ]
 */
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        // filtry (rovnosti / IN)
        $allowed = array_fill_keys([ 'id', 'invoice_id', 'line_no', 'description', 'unit_price', 'quantity', 'tax_rate', 'tax_amount', 'line_total', 'currency' ], true);
        ...
        if ($this->search !== null) {
            $searchCols = [ 'description', 'currency' ];
            $likeParts = [];
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'invoice_id', 'line_no', 'description', 'unit_price', 'quantity', 'tax_rate', 'tax_amount', 'line_total', 'currency' ], true);
            $parts = [];
